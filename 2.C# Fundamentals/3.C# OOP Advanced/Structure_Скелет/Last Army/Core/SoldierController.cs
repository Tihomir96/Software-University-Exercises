...
using System.Linq;
    ...
    public  void TeamGetBonus(Dictionary<string, List<ISoldier>> army, string rankerType)
        {
    ...
    public void TeamGoesOnVacation(Dictionary<string, List<ISoldier>> army, string rankerType)
        {
            foreach (var soldiers in army[rankerType])
            {
                soldiers.Regenerate();
